...
Convert calorie targets into macro grams with simple presets.
...
- Preset macro ratios
- Grams output for each macro
- Simple calorie-to-gram conversion
- Instant calculation

## How to use

1. Enter your daily calorie target
2. Choose a macro preset
3. Review grams for protein, fat, and carbs
