...
Estimate your lifestyle finance health with a simple score.
...
1. Rate income stability and savings rate
2. Enter emergency fund months and debt ratio
3. Review the financial health score
4. Check the zone label
...
- [Life Balance Analyzer](./life-balance-analyzer.md)
