...
Estimate your motivation index from simple daily inputs.
...
1. Enter goal clarity and recent progress
2. Add sleep hours and stress score
3. Rate your reward system
4. Review the motivation index and state
