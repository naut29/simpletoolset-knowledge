...
Score your day with a fast productivity index and focus ratio.
...
- Productivity index on a 0-100 scale
- Focus ratio percentage
- Weighted scoring with interruption penalties
- Client-side, deterministic output

## How to use

1. Enter deep work hours and focus time
2. Add interruptions and tasks completed
3. Review the productivity index and focus ratio
4. Compare different days and routines
...
- [Decision Fatigue Estimator](./decision-fatigue-estimator.md)
