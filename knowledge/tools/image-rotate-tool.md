...
Rotate images quickly with presets or custom angles. Perfect for fixing orientation or creating new layouts.
...
- Preset and custom rotation angles
- Automatic canvas resizing
- Instant preview
- Client-side processing
- Fast exports
- Handles photos, scanned pages, screenshots, or graphics with incorrect orientation.
- Produces a rotated image aligned to the intended portrait, landscape, or custom angle.

## How to use

1. Upload your image
2. Pick a rotation preset or enter custom degrees
