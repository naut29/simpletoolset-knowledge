...
Estimate burnout risk with simple weekly inputs and scoring.
...
- Low/Moderate/High/Critical levels
- Combines stress and sleep inputs
- Client-side calculations

## How to use

1. Enter weekly work hours and rest days
2. Add your stress and sleep scores
3. Review the burnout risk percentage
4. Check the warning level label
