...
Create clean hashtags from your keyword list with simple formatting rules.
...
- Keyword normalization and cleanup
- Optional accent removal
- CamelCase formatting toggle
- Hashtag limit control
- One-click copy
- Client-side processing

## How to use

1. Enter keywords separated by commas or new lines
2. Toggle accent removal or camelCase if needed
3. Set a hashtag limit
4. Copy the generated hashtags
5. Paste into your caption
