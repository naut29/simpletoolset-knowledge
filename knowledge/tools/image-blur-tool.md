...
Blur the entire image or just a selected area for privacy and visual effects.
...
- Blur entire image or selected area
- Adjustable blur strength
- Drag-to-select area blur
- Instant preview and download
- Runs locally in your browser
- Handles photos, screenshots, or visual assets that need softened detail.
- Produces a blurred image preview suitable for privacy masking, backgrounds, or design effects.

## How to use

1. Upload your image
2. Choose blur mode: full image or selected area
...
- [Image Watermark Tool](./image-watermark-tool.md)
- [Image Mirror & Flip](./image-mirror-flip.md)
