...
1. When this workflow helps: A useful interface palette needs more than one attractive color. This workflow helps designers create shade ramps, test contrast, and prepare gradient accents that are ready for buttons, panels, charts, and status states.
...
- [Aspect Ratio Calculator](../tools/aspect-ratio-calculator.md)

## Internal links

- [design tools category](../categories/design-tools.md)
- [Create Placeholder Assets For Mockups](./create-placeholder-assets-for-mockups.md)
