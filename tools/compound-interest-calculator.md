...
Project compound growth with contributions and effective annual rate.
...
- Supports periodic contributions
- Effective annual rate output
- Timing options for contributions
- Precision controls
- Instant results
...
1. Enter principal, contribution, and annual rate
2. Choose compounding frequency and timing
3. Review future value and interest earned
4. Adjust decimals or currency as needed
5. Reset inputs to start over
...
- [Inflation Calculator](./inflation-calculator.md)
