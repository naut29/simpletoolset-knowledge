...
Add emoji styling to captions and bios in seconds.
...
- Prefix, suffix, or wrap styles
- Preset emoji shortcuts
- Custom emoji input
...
1. Paste your text
2. Choose an emoji and style
3. Apply preset or custom emoji
4. Copy the decorated output
